...
function App() {
  ...
  return (
    <div className='app'>
      ...
      <Modal open={openSignIn} onClose={() => setOpenSignIn(false)}>
        <div style={modalStyle} className={classes.paper}>
          <form className='app_signin'>
            <center>
              <img className='app_headerImage' src="http://files.leagueathletics.com/Images/Club/13943/Instagram%20Logo%20PNG.png" alt="Instagram"/>
            </center>
      ...
      {
        authToken ? (
          <ImageUpload authToken={authToken} authTokenType={authTokenType} userId={userId} username={username}/>
        ) : (
          <h3> You need to login to upload a post</h3>
        )
      }
